...
\newcommand{\thesisDate}{de Octubre de 2025}
\newcommand{\thesisFullDate}{24~\thesisDate}
...
\input{front/01_portada}		% INCLUDE: all titlepages
\cleardoublepage
...
\input{front/02_declaracion}
\cleardoublepage

\input{front/03_dedicactoria}
\cleardoublepage

\input{front/04_agradecimientos}
\cleardoublepage

\input{front/05_cita}
\cleardoublepage

\input{front/06_abstracts}			% Include Spanish and Galcian
\cleardoublepage

\input{front/07_estructura}
\cleardoublepage

\input{front/08_prefacio}
\cleardoublepage
...
\input{body/01_introduccion}
\input{body/02_objetivos}
\input{body/03_resultados}
\input{body/04_discusion}
\input{body/05_conclusiones}
\input{body/06_futuro}
