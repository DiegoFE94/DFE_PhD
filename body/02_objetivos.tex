...
El objetivo principal de esta Tesis Doctoral es el \textbf{desarrollo y aplicación de metodologías bioinformáticas para la identificación de biomarcadores microbianos asociados a enfermedades humanas}. Esto se aborda con futuros fines diagnósticos, utilizando el análisis de datos de microbioma obtenidos mediante secuenciación masiva y técnicas de ML.
